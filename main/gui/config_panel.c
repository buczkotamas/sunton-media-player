...
lv_obj_t *config_panel_create(lv_obj_t *parent)
{
    ...
    lv_obj_align_to(backlight_timer_label, dimm_label, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 40);
    ...
    lv_label_set_text_fmt(wifi_label, "%s Wifi Signal: %d %%", LV_SYMBOL_WIFI, http_client_wifi_signal_quality_get());
    lv_obj_align_to(wifi_label, backlight_timer_label, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 40);
    //
